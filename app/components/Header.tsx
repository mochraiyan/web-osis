...
export default function Header() {
  ...
  return (
    <>
      <div
        style={headerStyle}
        className={`${curveClass} z-10 bg-cover bg-center lg:bg-bottom h-screen w-full shadow-2xl rounded-none sm:rounded-b-2xl lg:rounded-b-4xl lg:rounded-bl-4xl relative`}
      >
        <NavBar />
        {config.children}
      </div>
